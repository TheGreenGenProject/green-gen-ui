...
rightLegendPanel: List (Attribute msg)  -> List (String, Color) -> Element msg -> Element msg
rightLegendPanel attrs entries comp = row [spacing 10] [ comp, legend attrs entries]
